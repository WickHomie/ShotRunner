...
public class SwipeDetection : MonoBehaviour
{
    ...
    void Update()
    {
        if (!isMobile)
        {
            ...
            {
                isSwiping = true;
                tabPosition = Input.mousePosition;
            }
        ...
        else
        {
            if (Input.touchCount > 0)
            {
                ...
                {
                    isSwiping = true;
                    tabPosition = Input.GetTouch(0).position;
                }
    ...
    private void CheckSwipe()
    {
        ...
        if (isSwiping)
        {
            ...
            {
                swipeDelta = (Vector2)Input.mousePosition - tabPosition;
            }
            else if (Input.touchCount > 0)
            {
                swipeDelta = Input.GetTouch(0).position - tabPosition;
            }
